...
def output_profile_plot(geoc_ml_path,output_geoc,model,location,vertex_path):
 

    global ifgdates2, in_dir,out_dir, pixsp_a, pixsp_r,EQA_dem_par, locations,opt_model, vertex
    in_dir = geoc_ml_path
    ...
    for ii in range(n_ifg2):
        ...
        # try:
        plot_location_and_profile(unw_file,Inc_file,Head_file,vertex,EQA_dem_par,opt_model,locations,ii)
            # except:
            #     print(ii)
    # except:
    #     pass 
...
if __name__ == '__main__':
    ...
    output_profile_plot(geoc_ml_path,output_geoc,model,location,vertex_data)